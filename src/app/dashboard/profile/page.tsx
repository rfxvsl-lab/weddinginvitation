...
export default function ProfilePage() {
  ...
  const canChangeSlug = currentUser.packageId === 'medium' || currentUser.packageId === 'premium' || currentUser.packageId === 'luxury';
  const maxSlugChanges = currentUser.packageId === 'medium' ? 1 : 2;
  const changesLeft = maxSlugChanges - (currentUser.slugChangeCount || 0);
