            ...
            <div className="max-h-[50vh] overflow-y-auto hide-scrollbar space-y-4 relative z-10 pb-4">
                {data?.gifts?.map((gift, i) => (
                    <div key={i} className="bg-black/30 p-4 rounded border border-[#D4AF37]/30">
                        ...
                        {gift.type !== 'address' && (
                            <button
                                onClick={() => { navigator.clipboard.writeText(gift.accountNumber); alert('Copied!'); }}
                                className="mt-3 px-4 py-1 border border-[#D4AF37]/50 text-[10px] text-[#D4AF37] hover:bg-[#D4AF37] hover:text-black uppercase tracking-widest transition-colors rounded">
                                Copy
                            </button>
                        )}
                    </div>
                    ...
                    <form onSubmit={handleRSVPSubmit} className="space-y-4 text-left">
                        <div>
                            ...
                            <input
                                ...
                                disabled={!!guest}
                                className="w-full border-b border-gray-300 px-2 py-2 focus:outline-none focus:border-[#D4AF37] text-sm font-body bg-transparent"
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <select
                                    ...
                                    className="w-full border-b border-gray-300 px-2 py-2 focus:outline-none focus:border-[#D4AF37] text-sm font-body bg-transparent appearance-none"
                                >
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                rows={3}
                                className="w-full border-b border-gray-300 px-2 py-2 focus:outline-none focus:border-[#D4AF37] text-sm font-body bg-transparent resize-none"
                                placeholder="Tuliskan pesan Anda..."
                            />
                        </div>
                        <button
                            type="submit"
                            className="w-full mt-4 py-3 bg-[#1a1a1a] text-[#D4AF37] font-grand text-xs tracking-widest uppercase hover:bg-[#D4AF37] hover:text-black transition-colors shadow-lg border border-[#D4AF37]"
                        >
                            Kirim RSVP
                        </button>
                    </form>
...
const GrandBallroomLayout: React.FC<GrandBallroomProps> = ({ data, guest, onAddRSVP, rsvps }) => {
