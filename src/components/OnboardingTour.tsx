    ...
    return (
      <div className="fixed inset-0 z-[999] bg-black/80 backdrop-blur-md flex items-center justify-center p-6 select-none">
        ...
        >
          ...
          <p className="text-[var(--text-muted)] mb-8 text-sm">Di UndanganKita Invitation Builder. Untuk menyesuaikan panduan tutorial, perangkat apa yang sedang Anda gunakan saat ini?</p>
