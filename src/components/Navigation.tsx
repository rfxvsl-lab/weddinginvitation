...
export default function Navigation({ isDashboard = false }: NavigationProps) {
  ...
  return (
    <nav className="relative z-50 glass-nav px-8 py-5 flex items-center justify-between border-b border-[var(--color-outline-variant)]">
      <Link href="/" className="flex items-center gap-3">
        <div className="w-10 h-10 rounded-xl bg-rose-50 text-primary flex items-center justify-center shadow-inner border border-rose-100">
      ...
      {isDashboard ? (
        <div className="flex items-center gap-4">
          <div className="hidden md:flex items-center gap-6 mr-4 font-medium text-sm text-[var(--color-on-surface-variant)]">
            <Link href="/" className="flex items-center gap-1.5 hover:text-primary transition-colors">
              <House className="w-4 h-4" /> Beranda
            </Link>
            <Link href="/dashboard/profile" className="flex items-center gap-1.5 hover:text-primary transition-colors cursor-pointer">
        ...
        <>
          <div className="hidden md:flex items-center gap-8 font-medium text-sm text-[var(--color-on-surface-variant)]">
            <Link href="/" className="hover:text-primary transition-colors">Beranda</Link>
            <Link href="/fitur" className="hover:text-primary transition-colors">Fitur</Link>
            <Link href="/tema" className="hover:text-primary transition-colors">Tema</Link>
