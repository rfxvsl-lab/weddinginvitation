...
/** Set session cookie untuk digunakan oleh Next.js Middleware */
function setSessionCookie(user: SaaSUser) {
  try {
    ...
    // Session cookie: expires in 7 days, SameSite=Strict
    const expires = new Date(Date.now() + 7 * 24 * 60 * 60 * 1000).toUTCString();
    document.cookie = `saas_user_session=${encoded}; expires=${expires}; path=/; SameSite=Strict`;
  } catch (e) {
...
function clearSessionCookie() {
  document.cookie = 'saas_user_session=; expires=Thu, 01 Jan 1970 00:00:00 UTC; path=/; SameSite=Strict';
}
